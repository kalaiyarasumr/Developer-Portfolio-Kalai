...
const Service = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: <FiServer />,
      description:
        "I am very familiar with extracting insights from complex datasets to inform business decisions and strategies.",
    },
    {
      id: 3,
      title: "Web Design",
      icon: <BiPalette />,
      description:
        "I also provide Fully Responsive Static Website Design with HTML, CSS, Bootstrap, Tailwind,Figma,Wireframing.",
    },
    // {
    //   id: 4,
