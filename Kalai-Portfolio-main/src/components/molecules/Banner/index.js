  ...
  return (
    <div className="parent min-h-[100vh] flex flex-col-reverse lg:flex-row items-center justify-between">
      ...
      >
        ...
        <h1 className="text-4xl font-semibold mb-0 translate-y-[-50%] sm:translate-y-[-0%]">Kalaiyarasu M R</h1>
        <div className="my-4">
          <TypeAnimation
        ...
        <p className="text-neutral max-w-xl mb-6 font-medium translate-y-[-20%] sm:translate-y-[-0%]">
          As a developer,I am very passionate to my work and
          dedicated to explore New Tools And Technologies. With one year 
          experience in  web development, I specialize in frameworks like 
